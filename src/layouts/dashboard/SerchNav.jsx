                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2 max-w-xs">
                        {sessionStorage.getItem(ACCESS_TOKEN) ? (
                            ...
                            <div>
                                <Link to={'/auth/signin'} className=" hover:bg-gray-50 hover:text-mainBlack focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 focus:outline-none">
                                    Sign In
                                </Link>
